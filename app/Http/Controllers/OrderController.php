...
class OrderController extends Controller
{
    ...
    public function createOrder(Request $request) {
        $this->validate($request, [
            ...
            'installation_discount' => 'nullable|numeric',
            ...
            'price_for_day' => 'nullable|numeric',
            'price_for_transportation_per_km' => 'nullable|numeric',
            'number_of_trips' => 'nullable|numeric',
            'transportation_kms' => 'nullable|numeric',
            'route' => 'nullable',
            'services' => 'required',
