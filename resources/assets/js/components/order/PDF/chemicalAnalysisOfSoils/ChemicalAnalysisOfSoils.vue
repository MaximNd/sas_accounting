<template>
    <v-layout class="page">
        <appLeftImage image="/storage/image77.jpeg" size="300% 101%" positionX="54%" />
        <appServiceData :data="data" withYara />
    </v-layout>
</template>
        ...
        data() {
            return {
                ...
                data: [
                    ...
                    { icon: '/storage/image80.png', text: 'Доставка' },
                    { icon: '/storage/image79.png', text: 'Тестування' },
